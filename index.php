...
<div class="outter-form-login">
	<div id="wrapper">
	<div>
	<h3 class="text-center">TAMBAH PRODUK KARDI SHOP</h3>
	</div>
		<form action="proses.php" method="post" enctype="multipart/form-data">
			...
			<span>Size</span>
			<div class="form-group">
                    <input type="text" class="form-control" name="size" placeholder="Size XL/L/M/S">
            </div>
	...
	<div class="row">
            	...
            	<footer class="copyright text-center"><p>copyright; 2017 praktikumpemrogramanweb.com</p></footer>
			</div>
